package com.berkayozer.cart.service.application.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Sepet (Cart) işlemleri İSTİSNASIZ giriş yapmış kullanıcı gerektirir!
                        .requestMatchers("/api/v1/carts/**").authenticated()
                        // Geri kalan tüm işlemler geçerli bir token gerektirir
