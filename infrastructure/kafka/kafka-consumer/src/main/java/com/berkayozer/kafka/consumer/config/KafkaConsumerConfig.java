package com.berkayozer.kafka.consumer.config;

import com.berkayozer.kafka.config.data.KafkaConfigData;
import com.berkayozer.kafka.config.data.KafkaConsumerConfigData;
