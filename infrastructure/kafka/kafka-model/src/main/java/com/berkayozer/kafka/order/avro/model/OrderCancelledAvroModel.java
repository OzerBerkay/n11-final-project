...
public class OrderCancelledAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4907756572484424403L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderCancelledAvroModel\",\"namespace\":\"com.berkayozer.kafka.order.avro.model\",\"fields\":[{\"name\":\"sagaId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"orderId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"productId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"quantity\",\"type\":\"int\"}]}");
   ...
   */
  public OrderCancelledAvroModel(java.util.UUID sagaId, java.util.UUID orderId, java.util.UUID productId, java.lang.Integer quantity) {
    this.sagaId = sagaId;
   ...
   */
  public static com.berkayozer.kafka.order.avro.model.OrderCancelledAvroModel.Builder newBuilder() {
    return new com.berkayozer.kafka.order.avro.model.OrderCancelledAvroModel.Builder();
  }
   ...
   * @return A new OrderCancelledAvroModel RecordBuilder
   */
  public static com.berkayozer.kafka.order.avro.model.OrderCancelledAvroModel.Builder newBuilder(com.berkayozer.kafka.order.avro.model.OrderCancelledAvroModel.Builder other) {
    if (other == null) {
      return new com.berkayozer.kafka.order.avro.model.OrderCancelledAvroModel.Builder();
    } else {
      return new com.berkayozer.kafka.order.avro.model.OrderCancelledAvroModel.Builder(other);
    }
  }
   ...
   * @return A new OrderCancelledAvroModel RecordBuilder
   */
  public static com.berkayozer.kafka.order.avro.model.OrderCancelledAvroModel.Builder newBuilder(com.berkayozer.kafka.order.avro.model.OrderCancelledAvroModel other) {
    if (other == null) {
      return new com.berkayozer.kafka.order.avro.model.OrderCancelledAvroModel.Builder();
    } else {
      return new com.berkayozer.kafka.order.avro.model.OrderCancelledAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderCancelledAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.berkayozer.kafka.order.avro.model.OrderCancelledAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.berkayozer.kafka.order.avro.model.OrderCancelledAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.sagaId)) {
        this.sagaId = data().deepCopy(fields()[0].schema(), other.sagaId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.berkayozer.kafka.order.avro.model.OrderCancelledAvroModel.Builder setSagaId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.berkayozer.kafka.order.avro.model.OrderCancelledAvroModel.Builder clearSagaId() {
      sagaId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.berkayozer.kafka.order.avro.model.OrderCancelledAvroModel.Builder setOrderId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.berkayozer.kafka.order.avro.model.OrderCancelledAvroModel.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.berkayozer.kafka.order.avro.model.OrderCancelledAvroModel.Builder setProductId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.berkayozer.kafka.order.avro.model.OrderCancelledAvroModel.Builder clearProductId() {
      productId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.berkayozer.kafka.order.avro.model.OrderCancelledAvroModel.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.berkayozer.kafka.order.avro.model.OrderCancelledAvroModel.Builder clearQuantity() {
